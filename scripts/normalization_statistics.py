...
def compute_normalization_statistics(data_dir:Path, batch_size:int, img_size:int, interpolation:v2.InterpolationMode):
  '''
  ...
  train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, num_workers=12, generator=g)
...
if __name__ == "__main__":
  ...
  mean, std = compute_normalization_statistics(data_dir, BATCH_SIZE, IMG_SIZE, INTERPOLATION)
