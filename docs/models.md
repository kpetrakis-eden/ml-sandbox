...
| Model                          | F1 macro | Loss   |
| :----------------              | :------: | ----:  |
| res18mod-norm-wsampl-aug       | 70.1303  | 0.2994 |
| convnexttiny-norm-balanced-aug | 72.3760  | 0.2727 |
| convnextbase-norm-wsampl-aug   | 73.1875  | 0.2658 |

- Comparing model setups on expanded dataset (initial 6 classes)
...
NOTE: Initially Transformers results were only available in expanded bluebberies datasets (in which all models were more or less steadily above vanilla performance).
...
- Maybe tswin trasformers worth a bit more exploration.